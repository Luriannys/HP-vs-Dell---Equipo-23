...
public class CompanyViewDELL extends javax.swing.JFrame {
    ...
    public CompanyViewDELL() {
        ...
        pmActions.setText("Project Manager: " + dell.getPm().getAccion());
        pmFaltas.setText("Faltas: " + dell.getDirector().getFaltas());
        pmDescuento.setText("Dinero descontado: " + dell.getDirector().getFaltas() * 100);
        directorActions.setText("Director: " + dell.getDirector().getAccion());
